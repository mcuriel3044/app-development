...
(function($)
{
	...
	function deserialize(element, data, clearForm)
	{
		...
		if (clearForm)
		{
			...
			$('select,input[type="text"],input[type="tel"],input[type="password"],input[type="hidden"],textarea', element).val('');
		}
		...
		for( key in kv ){
			...
			$('select[name="'+ key +'"],input[type="tel"][name="'+ key +'"],input[type="text"][name="'+ key +'"],input[type="password"][name="'+ key +'"],input[type="hidden"][name="'+ key +'"],textarea[name="'+ key +'"]', element).val(value);
		}
	}
})(jQuery);
